...
mean.fit(dados_frame_esc)

classificacao = mean.labels_
...
print((dados_concat.grupo == 4).sum())
print((dados_concat.grupo == 3).sum())
print((dados_concat.grupo == 2).sum())
print((dados_concat.grupo == 1).sum())
print((dados_concat.grupo == 0).sum())
